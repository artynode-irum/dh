...
// Set bold font for addressee full name
$pdf->SetXY($border_margin + $padding, $heading_y + 20); // Position for the contact details (X, Y)
$pdf->SetFont("Arial", "B", 10); // Bold
$pdf->MultiCell($content_width, 8, $appointment['addressee_fname']);

// Set bold font for addressee address
$pdf->SetXY($border_margin + $padding, $heading_y + 25); // Position for the contact details (X, Y)
$pdf->SetFont("Arial", "B", 10); // Bold
$pdf->MultiCell($content_width, 8, $appointment['addressee_address']);

// Set bold font for office phone
$pdf->SetXY($border_margin + $padding, $heading_y + 30); // Position for the contact details (X, Y)
$pdf->SetFont("Arial", "B", 10); // Bold
$pdf->MultiCell($content_width, 8, "Ph: " . $appointment['addressee_phone']);
...
$pdf->SetXY($border_margin + $padding, $heading_y + 50); // Position for the contact details (X, Y)
$pdf->SetFont("Arial", "B", 10); // Bold
$pdf->MultiCell($content_width, 8, $appointment['name']);

// Set normal font for DOB text and bold for the DOB value
$pdf->SetXY($border_margin + $padding, $heading_y + 55); // Position for the contact details (X, Y)
...
$pdf->SetXY($border_margin + $padding, $heading_y + 60); // Position for the contact details (X, Y)
$pdf->SetFont("Arial", "B", 10); // Normal
...
$pdf->MultiCell($content_width, 10, "Thank you for seeing " . $appointment['name'] . " for your opinion and evaluation.");


if (!empty($appointment['referral_comment'])) {
    $pdf->SetFont("Arial", "", 10); // Change font style and size if needed
    $pdf->SetXY($border_margin + $padding, $heading_y + 90); // Position for the next text
    $pdf->MultiCell($content_width, 10, $appointment['referral_comment'] . "\nIf you require any additional information, please do not hesitate to contact me.");

} else {

    $pdf->SetFont("Arial", "", 10); // Change font style and size if needed
    $pdf->SetXY($border_margin + $padding, $heading_y + 100); // Position for the next text
    $pdf->MultiCell($content_width, 10, "If you require any additional information, please do not hesitate to contact me.");
}
