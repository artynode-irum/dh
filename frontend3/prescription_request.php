...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($status == 'pending'){
        ...
        $stmt->bind_param(
            ...
            $Id, $description, $payment, $name, $email, $phone, $dob, $address, $cityCode, $postcode, $stateCode, $timeZone, $card_number, $security_code, $expiration_date, $country, $gender, $title, $treatment, $prescriptionafter, $dosage, $previously_taken_medi, $currentlyppb, $health_condition, $known_allergies, $over_the_counter_drugs, $healthcare_provider_person_recently, $specific_medication_seeking, $known_nill_allergies, $medication_used_previously, $plan_schedule, $appointment_type, $appointment_day, $appointment_time, $adverse_reactions, $filePath, $reason_known_allergies_yes
        );
    }else{
    $query = "INSERT INTO prescription 
    ...
    $stmt->bind_param(
        ...
        $Id, $doctorId, $description, $payment, $name, $email, $phone, $dob, $address, $cityCode, $postcode, $stateCode, $timeZone, $card_number, $security_code, $expiration_date, $country, $gender, $title, $treatment, $prescriptionafter, $dosage, $previously_taken_medi, $currentlyppb, $health_condition, $known_allergies, $over_the_counter_drugs, $healthcare_provider_person_recently, $specific_medication_seeking, $known_nill_allergies, $medication_used_previously, $plan_schedule, $appointment_type, $appointment_day, $appointment_time, $adverse_reactions, $filePath, $reason_known_allergies_yes
    );
}
...
<div class="container-fluid m-0 p-0">
    <div class="content">
        <div class="request-form">
            ...
            <form action="prescription_request.php<?php echo isset($appointment['status']) ? '?status=' . $appointment['status'] . '&doctor_id=' . $appointment['doctor_id'] : '' ?>" id="requestForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-step" id="step3">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            ...
                            <!-- some hidden fiedls -->
                            <input type="hidden" readonly id="cityCode" name="cityCode" placeholder="City Code" value="<?php echo isset($appointment['city_code']) ? $appointment['city_code'] : '' ?>">
                            <input type="hidden" readonly id="postcode" name="postcode" placeholder="Postcode" value="<?php echo isset($appointment['postcode']) ? $appointment['postcode'] : '' ?>">
                            <input type="hidden" readonly id="stateCode" name="stateCode" placeholder="State Code" value="<?php echo isset($appointment['state_code']) ? $appointment['state_code'] : '' ?>">
                            <input type="hidden" readonly id="countryCode" name="countryCode" placeholder="Country Code" value='AU'>
                            <input type="hidden" readonly id="latitude" name="latitude">
                            <input type="hidden" readonly id="longitude" name="longitude">
                            <input type="hidden" readonly id="timeZone" name="timeZone" value="<?php echo isset($appointment['area_timeZone']) ? $appointment['area_timeZone'] : '' ?>">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" class="width-hundred" name="medicare_number" id="medicare_number"
                                    ...
                                    oninput="formatMedicareNumber(this)" value="<?php echo isset($appointment['	medicare_number']) ? $appointment['	medicare_number'] : '' ?>">
                            </div>
                        </div>
                    </div>
