...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        ...
        require '../emails/referral_mail.php';
...
<br>
                    ...
                    <div class="row">
                        <div class="col-9 col-md-6">
                            <div class="input-group">
                                <i class="fa-solid fa-cake-candles" style="z-index: 6;"></i>
                ...
                <div class="form-step" id="step2">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <label for="appointment-type"><b>Book an appointment <br><br> Choose Appointment Date and
