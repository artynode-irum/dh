...
function validateStep(stepNumber) {
  ...
  switch (stepNumber) {
    case 1:
      ...
      // Check if the display style of phone_error is not 'none'
      // const phone_error = document.getElementById('phone-error');
      // if (phone_error.style.display !== 'none') {
      //     phone_error.classList.add('input-error');
      // } else {
      //     phone_error.classList.remove('input-error');
      // }
