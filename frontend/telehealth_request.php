...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $card_number = "";
    $security_code = "";
    $medicare_number = $_POST['medicare_number'] ?? null;
...
// endif; 
?> -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCfDEB0GQd1uRQHOUy5qQDpzzElbskoQV8&libraries=places"></script>
