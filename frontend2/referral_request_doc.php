                ...
                <div class="doctor_referral">
                    ...
                    <section class="doctor-referral-second-section">
                        <div class="row">
                            <div class="col-12">
                                <div class="input-group doc-second-section-divs">
                                    <label for="test-required">Tests Required</label>
                                    <input type="text" name="test-required" id="test-required" class="width-hundred"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-group doc-second-section-divs">
                                    <label for="clinic-notes">Clinic Notes</label>
                                    <input type="text" name="clinic-notes" id="clinic-notes" class="width-hundred" placeholder="Clinical Notes"
                                        required>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-3">
                                <div class="input-group doc-second-section-divs">
                                    ...
                                    <input type="time" name="lab-use-only" id="lab-use-only" class="width-hundred"
                            ...
                            <div class="col-12 col-md-3">
                                <div class="input-group doc-second-section-divs">
                                    ...
                                    <input type="text" name="specimen-collected" id="specimen-collected"
                                        class="width-hundred" placeholder="Collected by:" required>
                                </div>
                            </div>
                            <div class="col-12 col-md-3">
                                <div class="input-group doc-second-section-divs">
                                    ...
                                    <input type="text" name="specimen-received" id="specimen-received"
                                        class="width-hundred" placeholder="Received by:" required>
                                </div>
                            </div>
                            <div class="col-12 col-md-3">
                                <div class="input-group doc-second-section-divs">
