        ...
        <body>
            ...
            <div class="email-container">
                ...
                <div class="content">
                    ...
                    <p>You have received a new message from your patient, ' . $patient . '.</p>
                    <p><strong>Message:</strong> "' . $message . '"</p>
                    <p>Please click the button below to view and respond to the message.</p>
                    <p><a href="#" class="button">View Message</a></p>
