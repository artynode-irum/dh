...
try {
    ...
    //Content
    $mail->isHTML(true);
    $mail->Subject = 'Chat Notification';
        ...
        <body>
            ...
            <div class="email-container">
                ...
                <div class="content">
                    ...
                    <p>Your doctor, ' . $doctor . ', has sent you a new message regarding your recent consultation.</p>
                    <p><strong>Message:</strong> "'.$message.'"</p>
                    <p>Please click the button below to view and respond to the message in your account.</p>
                    <p>
                        <a href="#" class="button">View Message</a>
                    </p>
                    <p>Thank you for choosing our service. We are committed to providing you with the best healthcare experience.</p>
                </div>
                <div class="footer">
