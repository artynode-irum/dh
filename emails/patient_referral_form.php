...
// Function to send the specialist email
    ...
    $certificateLink = 'http://localhost/dh/referral_patient_pdf.php?id=' . $appointment_id; // Replace with the actual certificate link
    ...
    <body>
        ...
        <div class="email-container">
            ...
            <div class="content">
                <h2>Dear Patient,</h2>
                <p>
                    Your doctor provided you a referral form. You can download it by clicking on the button below.
                </p>
                ';

    $emailContent .= '
    <a href="' . $certificateLink . '" class="button">View Referral Form</a>
    <br>
    <h4>Note:</h4> <small>The email you used here is your login email.</small>
    
    </div>
    <div class="footer">
        <p>If you have any questions or need assistance with your referral form, please contact our support team at <a href="mailto:info@doctorhelp.com.au">info@doctorhelp.com.au</a>.</p>
