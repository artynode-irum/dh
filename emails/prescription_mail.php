...
$prescriptionLink = "prescription"; // Replace with the actual prescription link
$telehealthLink = "telehealth-session"; // Replace with the actual telehealth link
...
<head>
    ...
    <title>Prescription Request Confirmation</title>
    <style>
        body,
        html {
            margin: 0;
...
<body>
    ...
    <div class="email-container">
            <h1>Your Prescription Request</h1>
        <div class="content">
            <h2>Hello ' . $name . ',</h2>
            <p>
                Thank you for submitting your prescription request. We\'re pleased to confirm that your request has been successfully submitted.
            </p>
                       <p>
...
if ($doctorAssigned) {
    $emailContent .= '
            <h2>Prescription Processed</h2>
            <p>
                Your prescription request has been processed. Please click the link below to start your video consultation with the doctor and receive your prescribed medications:
            </p>
            <a href="' . $telehealthLink . '" class="button">Join Video Consultation</a>';
} else {
    $emailContent .= '
            <h2>Prescription Request Received</h2>
            <p>
                We are currently working to assign you a doctor. Once a doctor has been assigned, we will send you a follow-up email with a link to start your video consultation for the prescription.
            </p>';
}
...
$emailContent .= '
            ...
            <p>
                <strong>Before the Consultation:</strong><br>
            ...
            <p>
                <strong>During the Consultation:</strong><br>
        ...
        <div class="footer">
            <p>If you have any questions or need help with your prescription, please contact our support team at <a href="mailto:info@doctorhelp.com.au">info@doctorhelp.com.au</a>.</p>
...
try {
    ...
    //Content
    $mail->isHTML(true);
    $mail->Subject = 'Prescription Confirmation';
