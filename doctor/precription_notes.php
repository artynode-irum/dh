...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Get existing data for the prescription
    $query = "SELECT notes FROM prescription WHERE id = ?";
    ...
    $query = "UPDATE prescription SET notes = ? WHERE id = ?";
    $stmt = $conn->prepare($query);
    $stmt->bind_param("si", $json_data, $prescription_id);
    $stmt->execute();
    $stmt->close();
...
<div class="second-section">
    <section>
        ...
        <div class="container mt-5">
            <h2 class="page-header">Edit Notes for Prescription ID <?php echo htmlspecialchars($prescription_id); ?>
            </h2>
