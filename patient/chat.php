...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !empty($_POST['message'])) {
    ...
    $sender = 'patient'; // Since the patient is sending the message
    ...
    $stmt->execute();
    $stmt->close();
    require '../emails/chat_notification_mail_for_doctor.php';

    // Redirect to prevent resubmission on page refresh
    header("Location: chat.php?certificate_id={$certificate_id}&doctor_name={$doctor_name}&email={$email}");
    exit();
}
...
<div class="second-section">
    <section>
        ...
        <div>
            <h2 class="page-header">Chat for Medical Certificate ID: <?php echo $certificate_id; ?></h2>
