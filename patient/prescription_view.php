...
if ($prescription_id) {
    // $query = "SELECT patient.username AS patient_username, patient.email, doctor.username AS doctor_username, doctor.signature AS signature, prescription.description, prescription.prescribe, prescription.created_date, prescription.request_date_time, 
    ...
    <section>
        ...
        <div class="details-section">
            ...
            <div class="details-box">
                ...
                <p><strong>Doctor Prescription:</strong> <?php echo htmlspecialchars($prescription['prescribe']); ?></p>
                ...
                <p><strong>Prescription you are after:</strong> <?php echo htmlspecialchars($prescription['prescriptionafter']); ?>
                </p>
